...
#define SKIP_TICKS     30.0     // 1000 / 50fps
...
#define GAPHEIGHT        100     // pipe gap height
// floor size
#define FLOORH           10     // floor height (from bottom of the screen)
// grass size
#define GRASSH            3     // grass height (inside floor, starts at floor y)
...
// set arduino position of sound sensor
...
void game_start() {
  ...
  TFT.println("-BIRD-");
  TFT.setTextSize(0);
  TFT.setCursor( 10, TFTH2 - 40);
  TFT.println("Feat. ");
  TFT.setCursor( 24, TFTH2 - 30);
  TFT.println("Sound Controller");
  TFT.setTextSize(1.5);
  TFT.setCursor( TFTW2 - (12 * 3) - 1, TFTH2 + 38);
